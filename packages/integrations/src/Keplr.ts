    ...
    if (props.ibcProps) {
      ...
      const response = await client
        .signAndBroadcast(
          ...
          messages,
          fee,
          "tpknam1qzv6ka97rc9nt9dq5zy5pa8kfuv09x8xmjtcm0uen0627k8lnucyk2g0hwh" // tx memo
          // `${this.chain.alias} (${this.chain.chainId})->Namada` // previous default tx memo
          // empty timeout height
        )
        .catch((e) => {
          return Promise.reject(e);
        });
